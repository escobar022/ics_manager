	...
	*/
    ...
    function show_custom_meta_box() {
        ...
        $custom_meta_fields = array(
            ...
            array(
                'label' => 'Meeting Intervalsel Day',
                'desc' => 'Interval Select',
                'id' => $prefix . 'intervalselday',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval Day',
                'desc' => 'Interval Select',
                'id' => $prefix . 'intervalday',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval Select Day Week',
                'desc' => 'Interval Select',
                'id' => $prefix . 'intervalseldayweek',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval Interval Day Week',
                'desc' => 'Interval Select',
                'id' => $prefix . 'intervaldayweek',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval Days Week',
                'desc' => 'Interval Select',
                'id' => $prefix . 'daysweek',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval Select Month',
                'desc' => 'Interval Select',
                'id' => $prefix . 'intervalselmonth',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval Month',
                'desc' => 'Interval Select',
                'id' => $prefix . 'intervalmonth',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval Month Day',
                'desc' => 'Interval Select',
                'id' => $prefix . 'bymonthday',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval By Set POS Month',
                'desc' => 'Interval Select',
                'id' => $prefix . 'bysetposmonth',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval By Days Month',
                'desc' => 'Interval Select',
                'id' => $prefix . 'bydaysmonth',
                'type' => 'text'
            ),
            array(
                'label' => 'Meeting Interval Month Order',
                'desc' => 'Interval Select',
